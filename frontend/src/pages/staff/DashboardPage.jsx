...
import PrescriptionQueue from "../../components/dashboard/PrescriptionQueue.jsx";
import InventoryManager from "../../components/dashboard/InventoryManager.jsx";
import ProductManager from "../../components/dashboard/ProductManager.jsx";
import OrderFulfillment from "../../components/dashboard/OrderFulfillment.jsx"; // <-- IMPORT
...
const DashboardPage = () => {
  ...
  const staffRolesWithFulfillment = ["cashier", "branchManager", "pharmacist"];
  ...
  return (
    <div className="bg-slate-100 flex-grow">
      <div className="container mx-auto px-6 py-10">
        ...
        {staffRolesWithFulfillment.includes(user.role) && (
          <div className="mt-10">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">
